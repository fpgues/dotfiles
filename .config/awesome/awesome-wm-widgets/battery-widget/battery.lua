...
local function worker(user_args)
    ...
    --local path_to_icons = args.path_to_icons or "/home/filipe/Downloads/symbolic/"
    local path_to_icons = args.path_to_icons or '/home/filipe/.config/awesome/awesome-wm-widgets/battery-widget/widgets/'
    ...
    elseif display_notification_onClick then
        battery_widget:connect_signal("button::press", function(_,_,_,button)
            if (button == 1 or 3) then show_battery_status(batteryType) end
        end)
        battery_widget:connect_signal("mouse::leave", function() naughty.destroy(notification) end)
    end
